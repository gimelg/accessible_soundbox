...
8. LID (TOP COVER)
	...
	*/
	...
	// This swaps which end gets speakers vs. pouch without rewriting placement math.
...
module base() {
	...
	if (CENTER_CATCH_ENABLE) {
		...
		// The table is optionally rotated about center in SHOW modes.
		// Match the support post to the rotated table's + intersection location.
